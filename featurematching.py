...
#FLANN library hai based on approximate nearest neighbour algorithm
# do dictionaries use hoti hai FLANN mein - index_param aur search_param
# ye batayega konsa algorithm use kar rahe hai aur uske parameters
...
def load_input():
	...
	input_image = cv2.resize(input_image, (550,500),interpolation=cv2.INTER_AREA)
